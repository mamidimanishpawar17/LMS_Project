...
namespace BuildAPI.Controllers
{
    ...
    public class SubjectAPIController : ControllerBase
    {
        ...
        public async Task<ActionResult<APIResponse>> GetSubjects([FromQuery(Name = "filteravailability")] Boolean IsActive,
        ...
        public async Task<ActionResult<APIResponse>> DeleteSubject(int id)
        {
            try
            {
                ...
                await _dbSubject.UpdateAsync(Subject); // update record in the database
